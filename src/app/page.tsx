...
export default function Home() {
  return (
    <div className="transition-colors min-h-screen bg-neutral-200 dark:bg-neutral-800 text-black dark:text-white font-(family-name:--font-vt323)">
      <Header />
      <main className="flex flex-col items-center justify-center my-24">
        ...
        <section className="flex flex-col items-center justify-center  text-center gap-10 my-12 px-4">
          ...
          <p className="text-xl text-cyan-800 dark:text-yellow-200 text-center">...estos son los mejores proyectos que realicé hasta el momento</p>
          ...
          <div className="flex flex-col text-left gap-4">
            ...
            <p className="text-xl text-cyan-800 dark:text-yellow-200">{`//…Aplicacion full stack e-commerse diseñada en react y utilizando como base de datos firebase;`}</p>
          </div>
          ...
          <div className="flex flex-col text-left gap-4">
            ...
            <p className="text-xl text-cyan-800 dark:text-yellow-200">{`//…pagina web diseñada con el framework bootstrap y vanilla Js;`}</p>
          </div>
          <div className="flex flex-col text-left gap-4">
            <Image
              src="/9z.webp"
            ...
            <p className="text-xl text-cyan-800 dark:text-yellow-200">{`//…pagina web dedicada al equipo de esports 9z Team mas especificamente a su equipo de cs2;`}</p>
          </div>
        </section>
